...
<section class="content-header">
  <div class="btn-group btn-breadcrumb">
    ...
    <a  class="btn btn-default  btn-xs active">Add Service Category</a>
  </div>
</section>
    ...
    <div class="col-md-12">
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">Add New Service Category</h3>
        </div>
        <div class="box-body">
          <form method="post" id="Simpan"  action="<?php echo base_url().'index.php/Service_category/add_service_category'; ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" name="max_waiting_time" id="max_waiting_time"  data-validation="length" data-validation-length="min4" data-validation-error-msg="Please fill out category name..."  class="form-control"  placeholder="">
            </div>
