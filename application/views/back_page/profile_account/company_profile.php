        ...
        <div class="box-body">
          ...
          <div class="form-group col-md-12 text-center">
            ...
            <div class="form-group text-center">
              <label for="profile_image" class="btn">
                <img src="<?php if (empty($user[0]->ProfileImage)) {
                  ...
                  echo base_url().'assets/pic_file/'.$user[0]->ProfileImage;
            ...
            <div class="form-group col-lg-12">
              ...
              <input type="text" name="phone_number" id="phone_number" value="<?php echo $user[0]->PhoneNumber; ?>" data-validation="length" data-validation-length="min4" data-validation-error-msg="Please fill out category description..."  class="form-control"  placeholder="">
            </div>
            <div class="form-group col-lg-12">
